...
public class PointsManager : MonoBehaviour {
    ...
    {
        //PointArea variables
        float offset = (GameObject.Find("Canvas").GetComponent<RectTransform>().rect.height) / 540.0f;
        int padding = 0;
        int baseScreenResolutionHeight = 540;


        //Lines Variables
        float lineHeight = (baseScreenResolutionHeight - padding) / numberLines;
        float paddingLine = 10.5f;

        //Points Variables
        int sizePoint = (int)(lineHeight * 0.7f);
        ...
        pointsArea.GetComponent<BoxCollider>().size = new Vector3( (baseScreenResolutionHeight - padding) * offset,
            (baseScreenResolutionHeight - padding) * offset,
        ...
        int emptyLineAreaSize = ((int)((baseScreenResolutionHeight - 10.0) - (2 * paddingLine)) - (numberPointsInLine * sizePoint)) / (numberPointsInLine - 1);
