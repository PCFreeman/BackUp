...
public class TAnimationMagager : MonoBehaviour
{
    ...
    public static TAnimationMagager mTAnimation = null;
    int mTimebonus;
    int mScoreBonus;
    ...
    private void Awake()
    {
        ...
        else if (mTAnimation != this) //If instance already exists and it's not this:
        {
    ...
    public void TimeAnimation(ref GameObject point, ref GameObject currentshape)
    {
        ...
        mTimebonus = currentshape.GetComponent<TShapes>().timeBonus;
    ...
    public void ScoreAnimation(ref GameObject point, ref GameObject currentshape)
    {
        ...
        Vector3 pp = point.transform.position;
        mScoreBonus = currentshape.GetComponent<TShapes>().points;
